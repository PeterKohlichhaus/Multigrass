set :application, 'multigrass'
set :repo_url, 'https://github.com/PeterKohlichhaus/multigrass'
set :git_https_username, 'peterkohlichhaus'
set :git_https_password, 't3h_FISH'
